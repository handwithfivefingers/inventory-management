import React, { forwardRef, HTMLInputTypeAttribute, useEffect, useRef, useState } from "react";
...
export const SelectInput = forwardRef<HTMLDivElement, ISelectInput & actions>(
  (
    {
      label,
      name,
    ...
    return (
      <div className={styles.inputWrapper} ref={refs}>
        <InputLabel label={label} name={name} required={required} />
        <div
          className={cn(
            "relative rounded-md flex items-center w-full bg-slate-50 dark:bg-slate-700 outline-none",
            className,
          )}
