...
import * as usePermissionHooksModule from "~/hooks/use-permission";
const usePermissionHooks: any = usePermissionHooksModule;
...
describe("PermissionGuard Component", () => {
  ...
  it("should render fallback when provided and user lacks permission", () => {
    ...
    render(
      <PermissionGuard permission="CREATE" module="product" fallback={<div>No Permission</div>}>
        <button>Create Product</button>
      </PermissionGuard>,
    );
  ...
  it("should check multiple conditions (permission AND admin)", () => {
    ...
    render(
      <PermissionGuard permission="CREATE" module="product" requireAdmin>
  ...
  it("allows a permission when admin-only access is not required", () => {
    vi.mocked(usePermissionHooks.usePermission).mockReturnValue(true);
    vi.mocked(usePermissionHooks.useIsAdmin).mockReturnValue(false);
    vi.mocked(usePermissionHooks.useHasRole).mockReturnValue(false);
...
describe("PermissionButton Component", () => {
  ...
  it("should respect disabled prop", () => {
    ...
    render(
      <PermissionButton permission="CREATE" module="product" disabled>
        Create
      </PermissionButton>,
    );
  ...
  it("should call onClick when clicked and allowed", () => {
    ...
    render(
      <PermissionButton permission="CREATE" module="product" onClick={handleClick}>
        Create
      </PermissionButton>,
    );
