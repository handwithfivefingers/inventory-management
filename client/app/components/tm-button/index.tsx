...
const variants: IButtonVariants = {
  ...
  light:
    "bg-indigo-100 outline outline-transparent  active:outline-indigo-200 text-indigo-600 dark:text-white dark:bg-indigo-600",
  ghost:
    "bg-transparent outline outline-transparent  active:outline-indigo-200 text-indigo-600 dark:text-white dark:bg-indigo-600",
};
