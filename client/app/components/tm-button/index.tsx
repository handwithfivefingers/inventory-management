...
export const TMButton = ({ children, className, variant = "primary", component, onClick, htmlType, ...rest }: any) => {
  const Element = component || "button";
  return (
    <Element
      className={cn("px-6 py-1.5 rounded active:translate-y-[1px]", variants[variant as IVariants], className)}
